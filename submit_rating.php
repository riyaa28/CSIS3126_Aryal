...
include("global.php"); 
	...
	$user_review = mysqli_real_escape_string($connection, $_POST["user_review"]);
	$datetime = time();
    ...
    $query_run = mysqli_query($connection, $query);
		if($query_run){
			...
			echo "Unable to submit the review.";
	...
	if(isset($_POST["action"])){
		...
		$res = mysqli_query($connection, "SELECT * FROM review_table ORDER BY review_id DESC");
